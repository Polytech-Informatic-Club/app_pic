...
class Equipe {
  ...
  factory Equipe.fromJson(Map<String, dynamic> json) {
    ...
    List<Joueur> joueursList = joueursFromJson.map((item) => Joueur.fromJson(item)).toList();
  ...
  Map<String, dynamic> toJson() {
    return {
      'id': id,
      'nom': nom,
      'joueurs': joueurs.map((joueur) => joueur.toJson()).toList(), // Convert list of Joueur objects to JSON
    };
  }
}